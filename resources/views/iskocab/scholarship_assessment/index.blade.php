            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h4 class="card-title"><b>Scholars List</b></h4>
                                <p class="category">Printing of scholar assessment
                                </p>
                            </div>
                            <div class="col-lg-2">
...
<script>
    ...
    function printAssessment(id){
        window.open("/iskocab/assessment/print-assessment/" + id);
        //process loader true
        // processObject.showProcessLoader();
        // $.ajax({
        //     url:'/iskocab/assessment/print-assessment/' + id,
        //     type:'GET',
        //     dataType:'json',
