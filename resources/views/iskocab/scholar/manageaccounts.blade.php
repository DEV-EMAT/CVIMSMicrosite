            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h4 class="card-title"><b>Scholars Management</b></h4>
                                <p class="category">Update | View | Delete Scholars</p>
                            </div>
                            <div class="col-lg-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7">
                            <div class="form-group">
                                <label for="show_full_name">Full Name:</label>
                                <b><p style="font-weight:bold; font-size:15" id="show_full_name"></p></b>
                            </div>
                            <div class="form-group">
                                <label for="show_email">Email Address:</label>
                                <p id="show_email"></p>
                            </div>
                            <div class="form-group">
                                <label for="show_contact">Mobile Number:</label>
                                <p id="show_contact"></p>
                            </div>
                            <div class="form-group">
                                <label for="show_telephone">Telephone Number:</label>
                                <p id="show_telephone"></p>
                            </div>
                            <!-- School -->
                            <div class="form-group">
                                <label for="show_school">School</label>
                                <p id="show_school"></p>
                            </div>
                            <!-- Course -->
                            <div class="form-group">
                                <label for="show_course">Course</label>
                                <p id="show_course"></p>
                            </div>
                        </div>
                    </div>
                ...
                <form id="edit_form" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                <label>Sex *</label>
                                <select class="selectpicker form-control" name="edit_sex" id="edit_sex">
                            ...
                            <div class="form-group">
                                <label>School</label>
                                <select class="selectpicker form-control" data-live-search="true" name="edit_school" id="edit_school">
                                    <option value="" disabled selected>Select.....</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Course</label>
                                <select class="selectpicker form-control" data-live-search="true" name="edit_course" id="edit_course">
                                    <option value="" disabled selected>Select.....</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <select  class="selectpicker form-control" name="edit_civil_status" id="edit_civil_status">
                        ...
                        {{-- <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="selectpicker form-control" data-style="btn btn-primary"
                                    name="applicant_status" id="applicant_status">
                                    <option value="" disabled="" selected="">Select.....</option>
                                    <option value="0">NEW SCHOLAR</option>
                                    <option value="1">OLD SCHOLAR</option>
                                </select>
                            </div>
                        </div> --}}
...
<script>//Start of Function for Address
    ...
    $(document).ready(function () {
        ...
        //get schools
        $.ajax({
            url:'{{ route('school.find-all-school') }}',
            type:'GET',
            dataType:'json',
            success:function(response){
                for (let index = 0; index < response.length; index++)
                {
                    $('#edit_school').append('<option value='+response[index].id+'>'+ response[index].school_name+'</option>');
                    $('.selectpicker').selectpicker('refresh');
                }
            }
        })
        ...
        $.ajax({
            ...
            success:function(response){
                for (let index = 0; index < response.length; index++)
                {
                    $('#edit_course').append('<option value='+response[index].id+'>'+ response[index].course_code +'</option>');
                    $('.selectpicker').selectpicker('refresh');
                }
            }
        })
    ...
    const view = (id) => {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data[4]) $("#show_school").text(data[4].school_name);
                if(data[5]) $("#show_course").text(data[5].course_description);

                if(data[3].region)$("#show_region").text(data[3].region);
                if(data[3].province)$("#show_province").text(data[3].province);
                if(data[3].city)$("#show_city").text(data[3].city);
                if(data[3].barangay)$("#show_barangay").text(data[3].barangay);
    ...
    const edit = (id) => {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if(data[4]) $("#edit_school").val(data[4].id);
                if(data[5]) $("#edit_course").val(data[5].id);

                $("#province").empty();
                $("#city").empty();
                $("#barangay").empty();
                if(data[3].region_id){
                    $("#region").val(data[3].region_id);
                    ...
                    if(data[3].barangay_id)$("#barangay").val(data[3].barangay_id);
                }
