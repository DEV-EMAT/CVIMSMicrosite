                        ...
                        <form id="register_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label>School</label>
                                        <select class="selectpicker form-control" data-live-search="true" name="school" id="school">
                                            <option value="" disabled selected>Select.....</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label>Course</label>
                                        <select class="selectpicker form-control" data-live-search="true" name="course" id="course">
                                            <option value="" disabled selected>Select.....</option>
                                        </select>
                                    </div>
                                </div>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success:function(response){
                    for (let index = 0; index < response.length; index++)
                    {
                        $('#school').append('<option value='+response[index].id+'>'+ response[index].school_name+'</option>');
                        $('.selectpicker').selectpicker('refresh');
                    }
                }
            })
            ...
            $.ajax({
                ...
                success:function(response){
                    for (let index = 0; index < response.length; index++)
                    {
                        $('#course').append('<option value='+response[index].id+'>'+ response[index].course_code +'</option>');
                        $('.selectpicker').selectpicker('refresh');
                    }
                }
            })
