                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-lg-10">
                                    <h4 class="card-title"><b>Patient List</b></h4>
                                    <p class="category">Update | View | Delete</p>
                                </div>
                                <div class="col-lg-2">
...
<script>
                            ...
                            success: function (data) {
                                if (data.success) {
                                    ...
                                    swal.fire({
                                        ...
                                        text: "Successfully!",
                                        type: "success",
                                        html: "<b>Incident Registration Created",
                                        footer: '<a href = "mailto: enterprise.cabuyao@gmail.com">Send an email to us!</a>'
                                    })
    ...
    const activate = (id) =>{
        Swal.fire({
            ...
            html: "<b>Incident Category Restore",
            footer: '<a href = "mailto: enterprise.cabuyao@gmail.com">Send an email to us!</a>'
        }).then((result) => {
            if (result.value) {
                //show loader
