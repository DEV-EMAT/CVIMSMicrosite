            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-lg-10">
                                <h4 class="card-title"><b>Requirements List</b></h4>
                                <p class="category">Create | View | Update | Delete Requirement </p>
                            </div>
                            <div class="col-lg-2">
                                @can('permission', 'createRequirement')
                                <a data-toggle="modal" data-toggle="modal" data-target="#requirementModalAdd" class="btn btn-primary pull-right">
...
@can('permission', 'createRequirement')
<!-- Modal For Add -->
<div class="modal fade in" tabindex="-1" role="dialog" id="requirementModalAdd">
    <div class="modal-dialog" role="document">
        <form id="addRequirementsForm" method="post">
            @csrf
            @method('POST')
...
@can('permission', 'updateRequirement')
<!-- Modal For Edit -->
...
<script>
    $(document).ready(function () {
        ...
        @if(Gate::check('permission', 'createRequirement'))
        //add requirements
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            type: "POST",
                            data: $('#addRequirementsForm').serialize(),
                            dataType: "JSON",
                            success: function (data) {
                                if (data.success) {
                                    $('#requirementModalAdd').modal('hide');
                                    $("#addRequirementsForm")[0].reset();
    ...
    @if(Gate::check('permission', 'updateRequirement')) 
    //Select Data to edit
    const edit = (id) =>{
        $.ajax({
